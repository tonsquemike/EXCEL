...
import {formatoFechas} from '../functions'
...
export const anchuraXLS = [
    ...
    { header: '', key: 'gradoAcademico', width: 30 },
    { header: '', key: 'fechaIngreso', width: 25 },
    { header: '', key: 'fechaNombramiento', width: 25 },
    { header: '', key: 'fechaTitularidad', width: 25 },
    { header: '', key: 'fechaInicio', width: 23 },
    { header: '', key: 'fechaFin', width: 23 },
    { header: '', key: 'puesto', width: 35 },
...
export const reetiquetaRegistros = (registros) => {
    ...
    registrosEditar.forEach(registro => {
        if(registro.fechaIngreso){
            registro['fechaIngreso'] = formatoFechas(registro.fechaIngreso)
        }
        if(registro.fechaNombramiento){
            registro['fechaNombramiento'] = formatoFechas(registro.fechaNombramiento)
        }
        if (registro.fechaTitularidad) {
            registro['fechaTitularidad'] = formatoFechas(registro.fechaTitularidad)
        }
        if (registro.puesto) {
